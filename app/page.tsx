            ...
            <div className="bg-gray-50 py-16">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Open Source Project</h2>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            This project is open source and available on GitHub. Feel free to contribute, report issues, or use it in your own projects.
                        </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <a
                                href="https://github.com/coderdal/modify-pdf"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-x-2 rounded-md bg-gray-900 px-5 py-3 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"
                            >
